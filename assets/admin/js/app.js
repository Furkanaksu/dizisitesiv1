...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $(".input-datepicker").each(function (index) {
            var id = $(this).attr('id');
            $('#'+id).datepicker('setDate', new Date($('#'+id).val()));
        });
            ...
            if (themeColorCke) {
                if (themeColorCke === 'default') {
                    ...
                    if (themeLink.length) {
                        ...
                        console.log(base_url +'assets/admin/css/themes.css');
                        $('link[href="' + base_url +'assets/admin/css/themes.css"]')
        ...
        $('a', colorList).click(function(e){
            ...
            if (themeColor === 'default') {
                ...
                if (themeLink.length) {
                    ...
                    $('link[href="' + base_url +'assets/admin/css/themes.css"]').before('<link id="theme-link" rel="stylesheet" href="' + themeColor + '">');
                    themeLink = $('#theme-link');
                }
            }
