...
<img src="<?php echo base_url(); ?>assets/front/images/uploads/slider-bg.jpg" alt="Login Full Background" class="full-bg animation-pulseSlow">
...
<div id="login-container" class="animation-fadeIn">
    ...
    <div class="login-title text-center">
        <h1><i class="gi gi-flash"></i> <strong>ProUI</strong><br><small>SignUp <strong></strong> or <strong>Register</strong></small></h1>
    </div>
    <!-- END Login Title -->
    ...
    <div class="block push-bit">
        <!-- Login Form -->
        <form method="post" action="<?php echo base_url(); ?>Uyeislemleri/girisYap" id="form-login" class="form-horizontal form-bordered form-control-borderless">
            <?php
