...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url(); ?>assets/admin/mg/icon57.png" sizes="57x57">
...
<img src="<?php echo base_url(); ?>assets/admin/img/placeholders/backgrounds/login_full_bg.jpg" alt="Login Full Background" class="full-bg animation-pulseSlow">
...
<div id="login-container" class="animation-fadeIn">
    ...
    <div class="login-title text-center">
        <h1><i class="gi gi-flash"></i> <strong>ProUI</strong><br><small>Please <strong><?php echo $this->lang->line('deneme'); ?></strong> or <strong>Register</strong></small></h1>
    </div>
    <!-- END Login Title -->
    ...
    <div class="block push-bit">
        <!-- Login Form -->
        <form method="post" action="<?php echo site_url(); ?>admin/login_validation" id="form-login" class="form-horizontal form-bordered form-control-borderless">
            <?php
